...
const channels = [
    ...
    { id: 'qokqbdLqBno', name: 'Anúncios em Vídeo - Parte 1' },
    { id: '92kOD2jtppw', name: 'Anúncios em Vídeo - Parte 2' },
    { id: '7b9KnpaDUiY', name: 'Dando START nas Campanhas' },
    { id: '9C6AxAb-FHM', name: 'Ganhamos MAIS dinheiro (e vamos provar)' },
    { id: 'bm3w-FKGBR8', name: 'Otimizando as Campanhas Google Ads' },
    { id: 'uB0_iwYcZ0M', name: 'Vale a pena anunciar no Facebook Ads?' },
    { id: 'weXd8Ye5c7I', name: 'Facebook Ads Primeiros Passos' },
    { id: 'gE7vPlkQJNI', name: 'Crie um anúncio Facebook ou Instagram' },
    { id: 'ZaOUX2Dk1Kw', name: 'or que você deveria ter o Pixel do Facebook?' },
    { id: 'C0p30EWzobI', name: 'Configurando o Pixel do Facebook no WordPress' },
    { id: 'V54tKHILm-A', name: 'Estratégias de público para Facebook e Instagram' },
    { id: 'J82tVKzuCMg', name: 'Criando público para vender no Facebook e Instagram' },
    { id: 'LqJr2Eqatkc', name: 'Criando público para crescer no Facebook e Instagram' },
    { id: '5ly2K3nq1g8', name: 'Como atrair novos clientes no Instagram e Facebook' },
    { id: 'X_9KjMHp47A', name: 'Melhor estratégia para anunciar no Instagram e Facebook' },
    { id: '0-oK1jHVj0M', name: 'Como gerar tráfego pago no Instagram e Facebook' },
    { id: 'GnrHHQ6TTCE', name: 'Como criar anúncio de conversão no Instagram e Facebook' },
